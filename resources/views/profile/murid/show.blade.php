    ...
    <div class="max-w-3xl mx-auto bg-white rounded-3xl shadow-xl p-8 mt-10" data-aos="fade-up">
        <div class="flex flex-col items-center gap-6">
            ...
            <div data-aos="zoom-in">
                @if ($murid->photo)
                    <img src="{{ asset('storage/' . $murid->photo) }}" alt="Profile Photo"
            ...
            <div class="text-center space-y-1" data-aos="fade-up">
                <h2 class="text-3xl font-bold text-blue-700">{{ $murid->name }}</h2>
                <p class="text-sm text-gray-500">{{ $murid->email }}</p>
                ...
                @if ($murid->skill)
                    <div class="mt-3 text-gray-700">
                        ...
                        <span>{{ $murid->skill }}</span>
                    </div>
                @endif

                @if ($murid->identity_card)
                    <div class="mt-3">
                        <span class="font-medium text-gray-700">Kartu Identitas:</span>
                        <a href="{{ asset('storage/' . $murid->identity_card) }}" target="_blank"
